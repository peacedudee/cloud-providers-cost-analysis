...
*   **Text Requests:** **$0.00200 per request**.
...
*   **The Rate:** **$0.50 per minute** of active log analysis and design training.
...
Lex features a **12-month free tier** for new accounts:
*   **Text Requests:** **10,000 requests** per month.
*   **Speech Requests:** **5,000 requests** per month.
...
*   **Run-away Chatbot Designer Runs:** Running the Automated Chatbot Designer on huge collections of raw, uncleaned text logs without setting strict training parameters.
...
2.  **Toggle Telephony Streams Dynamically:**
    *   When routing voice calls in Amazon Connect or other telephony services:
    *   Do not stream the entire call audio to Lex.

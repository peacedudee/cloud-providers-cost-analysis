...
## 2. Billing Mechanics
1.  **Environment Base Hourly Fee (Continuous 24/7 Billing):** Billed hourly based on environment size (`mw1.small`, `mw1.medium`, `mw1.large`, `mw1.xlarge`).
...
*   **Amazon MWAA Free Tier:** None. Continuous base hourly fees ($0.49/hr minimum) apply immediately upon creation.
...
*   **Environment Sprawl (Multi-Environment Over-Provisioning):**
    ...
    *   *Math:* 5 small MWAA environments = **$1,788.50/month base ($21,462/year)** in idle infrastructure fees.

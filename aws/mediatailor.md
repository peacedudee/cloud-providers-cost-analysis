...
2.  **Channel Assembly:** Billed per hour that a linear OTT channel is running ($0.10 per channel-hour).
3.  **Ad Transcoding (Transcode On-Demand):** Includes 10 free ad creative transcodes per 1,000 ad insertions; extra transcodes are billed at standard MediaConvert rates.
